...
### 4. Table Comparisons
这里要具体谈一下数字，因为可以计算。
We can compare these same values using a tables as well. While the visual change isn’t as clear, we are able to read the exact values. For example, the percentage of 18-24 year old residents with a bachelors degree increased from 1.8% to 2.5% in TOD areas but decreased from 1.3% to 1.2% in other areas.
